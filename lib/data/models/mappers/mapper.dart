...
import 'package:mcnd_mobile/data/models/mappers/api_featured_media_mapper.dart';
...
@injectable
class Mapper with MapperPrayerTime, ApiFeaturedMediaMapper, ApiNewsPostMapper {
  const Mapper();
}
