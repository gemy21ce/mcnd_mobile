...
@GenerateMocks([AzanTimesService, Clock])
void main() {
  ...
  test('when api fails state is error', () async {
    ...
    when(azanTimesService.fetchTodayPrayersAndScheduleAheadNotifications())
        .thenAnswer(
  ...
  test(
      'when api returns result state is loaded and will schedule azan notifications',
      () async {
